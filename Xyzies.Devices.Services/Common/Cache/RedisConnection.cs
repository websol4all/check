...
namespace Xyzies.Devices.Services.Common.Cache
{
    ...
    public static class RedisConnection
    {
        ...
        static Lazy<IConnectionMultiplexer> multiplexer = CreateMultiplexer();

        public static IConnectionMultiplexer Connection { get { return multiplexer.Value; } }
        ...
        public static void SetConnectionMultiplexer(IConnectionMultiplexer connectionMultiplexer)
        {
            multiplexer = new Lazy<IConnectionMultiplexer>(() => connectionMultiplexer) ??
        ...
        private static Lazy<IConnectionMultiplexer> CreateMultiplexer()
        {
            return new Lazy<IConnectionMultiplexer>(() => ConnectionMultiplexer.Connect(connectionString));
        }

        private static void CloseMultiplexer(Lazy<IConnectionMultiplexer> oldMultiplexer)
        {
